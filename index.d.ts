declare module 'react-native-sodium' {
     ...
     */
    export function crypto_auth_verify(tag: string, message: string, key: string): Promise<number>;
     ...
     */
    export function crypto_box_beforenm(publicKey: string, secretKey: string): Promise<string>;
    ...
    export function crypto_scalarmult(secretKey: string, publicKey: string): Promise<string>;
     ...
     */
    export function crypto_box_seal(message: string, publicKey: string): Promise<string>;
     ...
     */
    export function crypto_sign_detached(msg: string, secretKey: string): Promise<string>;
     ...
     */
    export function crypto_sign_seed_keypair(seed: string): Promise<{sk: string; pk: string}>;

    /**
     * Extracts the seed from the secret key.
     */
    export function crypto_sign_ed25519_sk_to_seed(secretKey: string): Promise<string>;

    /**
     * Converts an Ed25519 public key to an X25519 public key.
     */
    export function crypto_sign_ed25519_pk_to_curve25519(publicKey: string): Promise<string>;

    /**
     * Converts an Ed25519 secret key to an X25519 secret key
     */
    export function crypto_sign_ed25519_sk_to_curve25519(secretKey: string): Promise<string>;

    /**
     * Extracts the seed from the secret key sk.
     */
    export function crypto_sign_ed25519_sk_to_pk(secretKey: string): Promise<string>;
